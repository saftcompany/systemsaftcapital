            ...
            <div class="card rounded-2 overflow-hidden shadow">
                <div class="card-header">
                    <div class="card-title">
                        <h5 class="text-muted">{{ __('Deposit Via') }} {{ __(@$deposit->gateway->name) }}</h5>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <div class="row mt-4">
                            <div class="md:col-span-12">
                                <button class="btn btn-success ml-1" data-modal-toggle="approveModal"
                                    ...
                                    $('#approveModal').find('.withdraw-amount').text('{{ getAmount($deposit->amount) . ' ' . $deposit->symbol }}');
...
@push('breadcrumb-plugins')
    <a href="{{ route('admin.deposit.list') }}" class="btn btn-outline-secondary"><i class="bi bi-chevron-left"></i>
        {{ __('Go Back') }} </a>
@endpush
@push('modals')
