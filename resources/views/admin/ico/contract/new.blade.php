    ...
    <form action="{{ route('admin.contracts.store') }}" method="POST" enctype="multipart/form-data" id="editToken">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <label class="form-label" for="name">{{ __('Contract Network') }}</label>
                            ...
                            <ul class="dropdown-menu dropdown-menu-end dropdown-mh" onmouseover="this.size=10;"
                                ...
                                @foreach ($networks as $network)
                                    <li><a class="dropdown-item"
                                            onclick="$('#network').text($(this).text());
                                $('#editToken').find('input[name=network_id]').val($(this).data('network_id'));"
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <label class="form-label" for="address">{{ __('Contract Address') }}</label>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <label class="form-label" for="symbol">{{ __('Contract Symbol') }}</label>
                        <div class="input-group mb-1">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="mb-3">
                            <label class="form-label" for="ABI">{{ __('Contract ABI, (JSON format)') }}</label>
                            <textarea class="form-control" id="ABI" name="ABI" rows="3">{{ old('ABI') }}</textarea>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <label class="form-label" for="wallet_address">{{ __('Wallet Address') }}</label>
                        <div class="input-group mb-1">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <label class="form-label" for="image">{{ __('Icon URL') }}</label>
                        <div class="input-group mb-1">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        ...
                        <div class="btn btn-outline-secondary btn-sm mb-1">
                            ...
                            <div class="form-check form-switch d-inline-block">
                                <input type="checkbox" class="form-check-input" data-bs-toggle="toggle" name="status"
            ...
            <div class="card-footer text-end m-1">
                <button class="btn btn-success" type="submit"><i class="bi bi-pencil-square"></i> {{ __('Add') }}
                </button>
            </div>
        </div>
    </form>
...
@push('breadcrumb-plugins')
    <a href="{{ route('admin.contracts.index') }}" class="btn btn-primary btn-sm"><i class="bi bi-chevron-left"></i>
        {{ __('Back') }}</a>
@endpush
