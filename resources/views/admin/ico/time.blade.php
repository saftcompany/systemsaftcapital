    ...
    <div id="newModal" class="modal fade text-start" tabindex="-1" aria-hidden="true" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.bot.time.store') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        ...
                        <div class="input-group mb-1">
                            <span class="input-group-text" for="type">{{ __('Duration Unit') }}</span>
                            <input type="text" class="form-control" id="type" name="type"
                                aria-label="Duration Type" aria-describedby="type" value="Day">
                        </div>
