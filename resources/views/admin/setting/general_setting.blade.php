...
@section('content')
    <form action="/admin/settings" method="POST" id="generalSettings">
                ...
                <div class="grid gap-5 xs:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            <option value="" @if (env('VUE_APP_I18N_LOCALE') == null || env('VUE_APP_I18N_LOCALE') == '') selected @endif disabled="">
                                {{ __('Choose an option') }}
                            </option>
                            <option value="ar" @if (env('VUE_APP_I18N_LOCALE') == 'ar') selected @endif>
                                Arabic
                            </option>
                            <option value="bn" @if (env('VUE_APP_I18N_LOCALE') == 'bn') selected @endif>
                                Bengali
                            </option>
                            <option value="de" @if (env('VUE_APP_I18N_LOCALE') == 'de') selected @endif>
                                German
                            </option>
                            <option value="en" @if (env('VUE_APP_I18N_LOCALE') == 'en') selected @endif>
                                English
                            </option>
                            <option value="es" @if (env('VUE_APP_I18N_LOCALE') == 'es') selected @endif>
                                Spanish
                            </option>
                            <option value="fa" @if (env('VUE_APP_I18N_LOCALE') == 'fa') selected @endif>
                                Farsi
                            </option>
                            <option value="fr" @if (env('VUE_APP_I18N_LOCALE') == 'fr') selected @endif>
                                French
                            </option>
                            <option value="id" @if (env('VUE_APP_I18N_LOCALE') == 'id') selected @endif>
                                Indonesian
                            </option>
                            <option value="it" @if (env('VUE_APP_I18N_LOCALE') == 'it') selected @endif>
                                Italian
                            </option>
                            <option value="ja" @if (env('VUE_APP_I18N_LOCALE') == 'ja') selected @endif>
                                Japanese
                            </option>
                            <option value="ko" @if (env('VUE_APP_I18N_LOCALE') == 'ko') selected @endif>
                                Korean
                            </option>
                            <option value="nb" @if (env('VUE_APP_I18N_LOCALE') == 'nb') selected @endif>
                                Norwegian
                            </option>
                            <option value="nl" @if (env('VUE_APP_I18N_LOCALE') == 'nl') selected @endif>
                                Netherlands
                            </option>
                            <option value="pt" @if (env('VUE_APP_I18N_LOCALE') == 'pt') selected @endif>
                                Portuguese
                            </option>
                            <option value="ru" @if (env('VUE_APP_I18N_LOCALE') == 'ru') selected @endif>
                                Russain
                            </option>
                            <option value="th" @if (env('VUE_APP_I18N_LOCALE') == 'th') selected @endif>
                                Thai
                            </option>
                            <option value="tr" @if (env('VUE_APP_I18N_LOCALE') == 'tr') selected @endif>
                                Turkish
                            </option>
                            <option value="vi" @if (env('VUE_APP_I18N_LOCALE') == 'vi') selected @endif>
                                Vietnamese
                            </option>
                            <option value="zh" @if (env('VUE_APP_I18N_LOCALE') == 'zh') selected @endif>
                                Chinese
                            </option>
                        </select>
                    </div>
                    <div>
                        ...
                        <select
                            ...
                            <option value="" @if (env('VUE_APP_I18N_FALLBACK_LOCALE') == null || env('VUE_APP_I18N_FALLBACK_LOCALE') == '') selected @endif disabled="">
                                {{ __('Choose an option') }}
                            </option>
                            <option value="ar" @if (env('VUE_APP_I18N_FALLBACK_LOCALE') == 'ar') selected @endif>
                                Arabic
                            </option>
                            <option value="bn" @if (env('VUE_APP_I18N_FALLBACK_LOCALE') == 'bn') selected @endif>
                                Bengali
                            </option>
                            <option value="de" @if (env('VUE_APP_I18N_FALLBACK_LOCALE') == 'de') selected @endif>
                                German
                            </option>
                            <option value="en" @if (env('VUE_APP_I18N_FALLBACK_LOCALE') == 'en') selected @endif>
                                English
                            </option>
                            <option value="es" @if (env('VUE_APP_I18N_FALLBACK_LOCALE') == 'es') selected @endif>
                                Spanish
                            </option>
                            <option value="fa" @if (env('VUE_APP_I18N_FALLBACK_LOCALE') == 'fa') selected @endif>
                                Farsi
                            </option>
                            <option value="fr" @if (env('VUE_APP_I18N_FALLBACK_LOCALE') == 'fr') selected @endif>
                                French
                            </option>
                            <option value="id" @if (env('VUE_APP_I18N_FALLBACK_LOCALE') == 'id') selected @endif>
                                Indonesian
                            </option>
                            <option value="it" @if (env('VUE_APP_I18N_FALLBACK_LOCALE') == 'it') selected @endif>
                                Italian
                            </option>
                            <option value="ja" @if (env('VUE_APP_I18N_FALLBACK_LOCALE') == 'ja') selected @endif>
                                Japanese
                            </option>
                            <option value="ko" @if (env('VUE_APP_I18N_FALLBACK_LOCALE') == 'ko') selected @endif>
                                Korean
                            </option>
                            <option value="nb" @if (env('VUE_APP_I18N_FALLBACK_LOCALE') == 'nb') selected @endif>
                                Norwegian
                            </option>
                            <option value="nl" @if (env('VUE_APP_I18N_FALLBACK_LOCALE') == 'nl') selected @endif>
                                Netherlands
                            </option>
                            <option value="pt" @if (env('VUE_APP_I18N_FALLBACK_LOCALE') == 'pt') selected @endif>
                                Portuguese
                            </option>
                            <option value="ru" @if (env('VUE_APP_I18N_FALLBACK_LOCALE') == 'ru') selected @endif>
                                Russain
                            </option>
                            <option value="th" @if (env('VUE_APP_I18N_FALLBACK_LOCALE') == 'th') selected @endif>
                                Thai
                            </option>
                            <option value="tr" @if (env('VUE_APP_I18N_FALLBACK_LOCALE') == 'tr') selected @endif>
                                Turkish
                            </option>
                            <option value="vi" @if (env('VUE_APP_I18N_FALLBACK_LOCALE') == 'vi') selected @endif>
                                Vietnamese
                            </option>
                            <option value="zh" @if (env('VUE_APP_I18N_FALLBACK_LOCALE') == 'zh') selected @endif>
                                Chinese
                            </option>
                        </select>
                    </div>
                    ...
                    @if ($general->staging != 1 && getExt(7) == 1)
                        <div>
                            ...
                            <input
                                ...
                                value="{{ env('VUE_APP_WALLET_CONNECT_PROJECT_ID') }}">
                    ...
                    @endif
                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">OpenExchangeRates APP ID
                        </label>
                        <input
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            type="text" name="OPENEXCHANGERATES_APP_ID" value="{{ env('OPENEXCHANGERATES_APP_ID') }}">
                        <small>{{ __('You can create app id from ') }}
                            <a href="https://openexchangerates.org/account/app-ids"
                                class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Openexchangerates</a></small>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="grid gap-5 xs:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                        <div>
                            ...
                            <input
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                type="text" name="TATUM_API_URL" value="{{ env('TATUM_API_URL') }}">
                        </div>
                        <div>
                            <label
                            ...
                            <input
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                type="text" name="TATUM_API_KEY" value="{{ env('TATUM_API_KEY') }}">
                        </div>
                        <div>
                            <label
                            ...
                            <input
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                type="text" name="TATUM_TESTNET_API_KEY" value="{{ env('TATUM_TESTNET_API_KEY') }}">
                        </div>
                        <div>
                            <label
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{ __('NETWORK') }}</label>
                            <select id="NETWORK" name="NETWORK" value="{{ env('NETWORK') }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                <option value=""
                                    {{ env('NETWORK') == null || env('NETWORK') == '' ? 'selected' : '' }}>
                                    {{ __('Choose an option') }}
                                </option>
                                <option value="testnet" {{ env('NETWORK') == 'testnet' ? 'selected' : '' }}>
                                    {{ __('testnet') }}</option>
                                <option value="mainnet" {{ env('NETWORK') == 'mainnet' ? 'selected' : '' }}>
                                    {{ __('mainnet') }}</option>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                value="{{ env('TESTNET_TYPE') ?? 'ethereum-sepolia' }}">
                        </div>
                        <div>
                            <label
                        ...
                        <div>
                            ...
                            <input
                                ...
                                value="{{ env('TATUM_RETRY_DELAY') ?? '1000' }}">
                        </div>
                    </div>
                </div>
            </div>
        ...
        @if (getExt(8) == 1)
            <div class="card my-10">
                <h4 class="card-header card-title">{{ __('P2P Settings') }}</h4>
                <div class="card-body">
                    <div class="grid gap-5 xs:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                        <div>
                            <label
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{ __('Network Fees') }}</label>
                            <div class="input-group">
                                <input name="p2p_network_fee" id="p2p_network_fee"
                                    type="number"value="{{ $p2p->network_fee ?? 0.0 }}" placeholder="0.00">
                                <span>%</span>
                            </div>
                            <small>{{ __('Network fee percentage for every completed p2p order') }}</small>
                        </div>
                        <div>
                            <label
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{ __('Currency of Application Wallet') }}</label>
                            <input name="p2p_application_wallet" id="p2p_application_wallet" class="form-control"
                                type="text"value="{{ $p2p->application_wallet ?? 'USDT' }}" placeholder="0.00">
                            <small>{{ __('Seller requirement: application wallet currency') }}</small>
                        </div>
                        <div>
                            <label
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{ __('Minimum Balance To Apply') }}</label>
                            <input name="p2p_application_balance" id="p2p_application_balance" class="form-control"
                                type="number"value="{{ $p2p->application_balance ?? 1000 }}" placeholder="0.00">
                            <small>{{ __('Seller requirement: application wallet balance') }}</small>
                        </div>
                    </div>
                </div>
            </div>
        @endif
        @if ($general->staging != 1)
            <div class="card my-10">
                ...
                <div class="card-body">
                    <div class="grid gap-5 xs:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                        <div>
                            ...
                            <input
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                type="text" name="PUSHER_APP_ID" value="{{ env('PUSHER_APP_ID') }}">
                        ...
                        <div>
                            ...
                            <input
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                type="text" name="PUSHER_APP_KEY" value="{{ env('PUSHER_APP_KEY') }}">
                        </div>
                        <div>
                            <label
                            ...
                            <input
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                type="text" name="PUSHER_APP_SECRET" value="{{ env('PUSHER_APP_SECRET') }}">
                        </div>
                        <div>
                            <label
                            ...
                            <select
                                ...
                                <option value="" @if (env('PUSHER_APP_CLUSTER') == '') selected @endif disabled="">
                                    {{ __('Choose an option') }}
                                </option>
                                <option value="mt1" @if (env('PUSHER_APP_CLUSTER') == 'mt1') selected @endif>
                                    mt1 (US East (N. Virginia))
                                </option>
                                <option value="ap1" @if (env('PUSHER_APP_CLUSTER') == 'ap1') selected @endif>
                                    ap1 (Asia Pacific (Singapore))
                                </option>
                                <option value="ap2" @if (env('PUSHER_APP_CLUSTER') == 'ap2') selected @endif>
                                    ap2 (Asia Pacific (Mumbai))
                                </option>
                                <option value="us2" @if (env('PUSHER_APP_CLUSTER') == 'us2') selected @endif>
                                    us2 (US East (Ohio))
                                </option>
                                <option value="ap3" @if (env('PUSHER_APP_CLUSTER') == 'ap3') selected @endif>
                                    ap3 (Asia Pacific (Tokyo))
                                </option>
                                <option value="us3" @if (env('PUSHER_APP_CLUSTER') == 'us3') selected @endif>
                                    us3 (US West (Oregon))
                                </option>
                                <option value="ap4" @if (env('PUSHER_APP_CLUSTER') == 'ap4') selected @endif>
                                    ap4 (Asia Pacific (Sydney))
                                </option>
                                <option value="eu" @if (env('PUSHER_APP_CLUSTER') == 'eu') selected @endif>
                                    eu (EU (Ireland))
                                </option>
                                <option value="sa1" @if (env('PUSHER_APP_CLUSTER') == 'sa1') selected @endif>
                ...
                <div class="grid gap-5 md:grid-cols-3">
                    ...
                    <div class="flex items-center pl-4  dark:border-gray-700">
                        <div class="flex items-center justify-between">
                            <input
                                class="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                type="checkbox" name="APP_DEBUG" @if (env('APP_DEBUG') == 'true') checked @endif>
                            <label class="py-4 ml-2 w-full text-sm font-medium text-gray-900 dark:text-gray-300"
