    @if ($user_kyc == null)
        <div class="lg:col-span-4 md:col-span-6">
            <div class="card">
                <div class="card-body text-center flex justify-center items-center border-light rounded">
    ...
    @if ($user_kyc !== null && isset($_GET['thank_you']))
        <div class="lg:col-span-4 md:col-span-6">
            <div class="card">
                <div class="card-body text-center flex justify-center items-center border-warning rounded">
    ...
    @if ($user_kyc !== null && $user_kyc->status == 'pending' && !isset($_GET['thank_you']))
        <div class="lg:col-span-4 md:col-span-6">
            <div class="card">
                <div class="card-body text-center flex justify-center items-center border-info rounded">
