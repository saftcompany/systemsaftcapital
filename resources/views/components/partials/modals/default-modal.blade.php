<div tabindex="-1" aria-hidden="true" data-modal-placement="center-center" data-modal-backdrop="static"
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (Array.isArray(response)) {
                            // If yes, iterate over it and notify each message
                            response.forEach(function(res) {
                                notify(res.type, res.message)
                            });
                        } else {
                            // If not, just notify the single message
