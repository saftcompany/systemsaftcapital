    ...
    <div class="grid grid-cols-1 gap-4 px-4 sm:gap-5 sm:px-5 lg:grid-cols-2">
        ...
        <div
            ...
            <div class="flex justify-between">
                ...
                <p class="text-xs text-gray-500 dark:text-gray-200">{{ $tooltip[0] }} {{ __('Amount') }}</p>
            </div>
        ...
        <div
            ...
            <div class="flex justify-between">
                <div>
                    ...
                    <span class="text-xs text-gray-500 dark:text-gray-200">{{ __('Order') }}</span>
                </div>
        ...
        <div
            ...
            <div class="flex justify-between">
                ...
                <p class="text-xs text-gray-500 dark:text-gray-200">{{ $tooltip[1] }} {{ __('Amount') }}</p>
            </div>
