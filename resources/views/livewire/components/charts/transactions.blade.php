<div class="card col-span-2 sm:col-span-2 md:col-span-1">
    <div class="card-header">
        ...
        <span class="rounded-full scale-125 p-1 shadow hover:bg-gray-300/20 focus:bg-gray-300/20 active:bg-gray-300/25"
    ...
    <div class="grid grid-cols-1 gap-4 px-4 sm:gap-5 sm:px-5 lg:grid-cols-2">
        <div class="rounded-lg border border-slate-150 p-4 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700">
            <div class="flex justify-between">
                <div>
                    ...
                    <span class="text-xs text-gray-500 dark:text-gray-200">{{ __('Transaction') }}</span>
                </div>
                <p class="text-xs text-gray-500 dark:text-gray-200">{{ __('Buy Orders') }}</p>
            </div>
        ...
        <div
            ...
            <div class="flex justify-between">
                <div>
                    <span
                        class="text-2xl font-medium text-slate-700 dark:text-gray-200">{{ number_format($data->buy['cost'], 2) }}</span>
                    <span class="text-xs text-gray-500 dark:text-gray-200">$</span>
                </div>
                <p class="text-xs text-gray-500 dark:text-gray-200">{{ __('Cost') }}</p>
            </div>
        ...
        <div
            ...
            <div class="flex justify-between">
                ...
                <p class="text-xs text-gray-500 dark:text-gray-200">{{ __('Sell Orders') }}</p>
            </div>
        ...
        <div
            ...
            <x-partials.progress title="Percentage" color="#64748b"
                percentage="{{ $data->sell['cost_percentage'] }}" />
        </div>
    </div>

    <div class="mt-4 flex grow items-center justify-between px-4 sm:px-5">
        <div class="flex items-center space-x-2">
            <p class="text-xs text-slate-800 dark:text-gray-200">{{ __('Since Last Week') }}</p>
