...
@push('modals')
    <x-partials.modals.default-modal title="{{ __('Set Profit') }}" action="{{ route('admin.forex.investment.set') }}"
        ...
        <div>
            ...
            <label class="form-control-label h6">{{ __('Profit Amount') }}</label>
        ...
        <div><label class="form-control-label h6">{{ __('Profit Calculation') }}</label>
        ...
        <div>
            <label for="result"
                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{ __('Result') }}</label>
