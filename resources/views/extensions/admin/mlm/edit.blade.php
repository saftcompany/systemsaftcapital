            ...
            <div class="card-body">
                <div class="grid gap-5 xs:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div>
                        ...
                        <input type="text" id="rank" name="rank" aria-label="Rank" aria-describedby="rank"
                            value="{{ $rank->rank }}" required
                            class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white placeholder-red-500">
                    </div>
                    <div>
                        ...
                        <div class="input-group">
                            <input type="number" id="margin" name="margin" aria-label="Rank Withdraw Margin"
                                aria-describedby="margin" value="{{ $rank->margin }}" required>
                    ...
                    @php
                        $stats = getPlatforms()->mlm;
                    @endphp
                    @if (isset($stats->deposits) && $stats->deposits == 1)
                        <div>
                            <div class="flex justify-between">
                                <label for="profit_missed"
                            ...
                            <div class="input-group">
                                <input type="text" id="deposit_commission" name="deposit_commission"
                                    aria-label="Deposit Commission" aria-describedby="deposit_commission"
                                    value="{{ $rank->deposit_commission }}" required>
                    ...
                    @endif
                    @if (isset($stats->first_deposit) && $stats->first_deposit == 1)
                        <div>
                            <div class="flex justify-between">
                                <label for="profit_missed"
                    ...
                    @endif
                    @if (isset($stats->active_first_deposit) && $stats->active_first_deposit == 1)
                        <div>
                            <div class="flex justify-between">
                                <label for="profit_missed"
                    ...
                    @endif
                    @if (isset($stats->trades) && $stats->trades == 1)
                        <div>
                            <div class="flex justify-between">
                                <label for="profit_missed"
                            ...
                            <div class="input-group">
                                <input type="text" id="trade_commission" name="trade_commission"
                                    aria-label="trade Commission" aria-describedby="trade_commission"
                                    value="{{ $rank->trade_commission }}" required>
                    ...
                    @endif
                    @if (getExt(1) == 1 && isset($stats->bot_investment) && $stats->bot_investment == 1)
                        <div>
                            <div class="flex justify-between">
                                <label for="profit_missed"
                    ...
                    @endif
                    @if (getExt(2) == 1 && isset($stats->ico_purchase) && $stats->ico_purchase == 1)
                        <div>
                            <div class="flex justify-between">
                                <label for="profit_missed"
                            ...
                            <div class="input-group">
                                <input type="text" id="ico_commission" name="ico_commission"
                                    aria-label="ico Commission" aria-describedby="ico_commission" required
                    ...
                    @endif
                    @if (getExt(4) == 1)
                        @if (isset($stats->forex_deposit) && $stats->forex_deposit == 1)
                            <div>
                                <div class="flex justify-between">
                                    <label for="profit_missed"
                                ...
                                <div class="input-group">
                                    <input type="text" id="forex_commission" name="forex_commission"
                                        aria-label="ico Commission" aria-describedby="forex_commission" required
                                        value="{{ $rank->forex_commission }}">
                        ...
                        @endif
                        @if (isset($stats->forex_investment) && $stats->forex_investment == 1)
                            <div>
                                <div class="flex justify-between">
                                    <label for="profit_missed"
                                ...
                                <div class="input-group">
                                    <input type="text" id="forex_investment_commission"
                                        name="forex_investment_commission" aria-label="ico Commission" required
                        ...
                        @endif
                    @endif
                    @if (getExt(6) == 1 && isset($stats->staking) && $stats->staking == 1)
                        <div>
                            <div class="flex justify-between">
                                <label for="profit_missed"
                            ...
                            <div class="input-group">
                                <input type="text" id="staking" name="staking" aria-label="Staking Commission"
                                    required aria-describedby="staking" value="{{ $rank->staking }}">
                    ...
                    @if ($stats->type == 'unilevel')
                        <div>
                            ...
                            <input type="text" id="deposits_required" name="deposits_required"
                                aria-label="Deposits Required" aria-describedby="deposits_required" required
                                value="{{ $rank->deposits_required }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white placeholder-red-500">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" id="direct_required" name="direct_required" required
                ...
                <div class="mt-5">
                    <label class="inline-flex relative items-center cursor-pointer">
                        <input type="checkbox" value="{{ $rank->status }}"
                            @if ($rank->status == 1) checked @endif class="sr-only peer"
