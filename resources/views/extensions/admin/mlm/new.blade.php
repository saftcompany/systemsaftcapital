            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="lg:col-span-3 md:col-span-4 xs:col-span-6">
                        ...
                        <div class="input-group mb-1">
                            <input type="text" class="form-control" id="rank" name="rank" aria-label="Rank"
                                aria-describedby="rank" value="{{ old('rank') }}">
                        </div>
                    </div>
                    <div class="lg:col-span-3 md:col-span-4 xs:col-span-6">
                        ...
                        <div class="input-group mb-1">
                            <input type="text" class="form-control" id="margin" name="margin"
                                aria-label="Rank Withdraw Margin" aria-describedby="margin" value="{{ old('margin') }}">
                        ...
                        <div class="lg:col-span-3 md:col-span-4 xs:col-span-6">
                            ...
                            <div class="input-group mb-1">
                                <input type="text" class="form-control" id="active_ref_commission"
                                    ...
                                    aria-describedby="active_ref_commission" value="{{ old('active_ref_commission') }}">
                            </div>
                        </div>
                    @endif
                            ...
                            <div class="lg:col-span-3 md:col-span-4 xs:col-span-6">
                                ...
                                <div class="input-group mb-1">
                                    <input type="text" class="form-control" id="forex_commission"
                                        ...
                                        aria-describedby="forex_commission" value="{{ old('forex_commission') }}">
                                </div>
                            </div>
                        @endif
                    ...
                    @if (getExt(6) == 1 && getPlatform('mlm')->staking == 1)
                        <div class="lg:col-span-3 md:col-span-4 xs:col-span-6">
                            <label for="staking">{{ __('Staking Commission') }}</label>
                            <div class="input-group mb-1">
                    ...
                    @if (getPlatform('mlm')->type == 'unilevel')
                        <div class="lg:col-span-3 md:col-span-4 xs:col-span-6">
                            <label for="deposits_required">{{ __('VIP Rank Deposit Required') }}</label>
                            <div class="input-group mb-1">
                                <input type="text" class="form-control" id="deposits_required"
                                    name="deposits_required" aria-label="Deposits Required"
                                    aria-describedby="deposits_required" value="{{ old('deposits_required') }}">
                            </div>
                        </div>
                        <div class="lg:col-span-3 md:col-span-4 xs:col-span-6">
                            <label for="bv_required">{{ __('VIP Rank BV Required') }}</label>
                            <div class="input-group mb-1">
                                <input type="text" class="form-control" id="bv_required" name="bv_required"
                                    aria-label="ico Commission" aria-describedby="bv_required"
                                    value="{{ old('bv_required') }}">
                            </div>
                        </div>
                        <div class="lg:col-span-3 md:col-span-4 xs:col-span-6">
                            <label for="direct_required">{{ __('VIP Rank Direct Referral Required') }}</label>
                            <div class="input-group mb-1">
