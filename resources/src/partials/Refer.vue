<template>
  <div class="card">
    <div class="card-body text-center">
      <div class="text-warning mb-2 flex items-center justify-center">
        <i class="bi bi-gift rounded-full px-2 py-1 text-2xl shadow"></i>
      </div>
      ...
      >
        {{
          ...
          (reward ? reward : 5) +
          "% " +
          $t("of every customer that completes 1 deposit in the platform.")
        }}
      </p>
      <button
        type="button"
      ...
      <Modal v-if="isShowModal" size="4xl" @close="closeModal()">
        ...
        <template #body>
          <div class="px-sm-4 mx-5 mb-10 text-center">
            ...
            <div class="grid md:grid-cols-3 xs:grid-cols-1 gap-5">
              <div class="card p-5 shadow">
                ...
                <div class="text-center">
                  <h6 class="fw-bolder mb-1">{{ $t("Send Invitation") }} 🤟🏻</h6>
                  <p>
                    {{ $t("Send your referral link to your friend") }}
                  </p>
                </div>
              </div>
              <div class="card p-5 shadow">
                ...
                <div class="text-center">
                  <h6 class="fw-bolder mb-1">{{ $t("Registration") }} 👩🏻‍💻</h6>
                  <p>
                    {{ $t("Let them register to our trading platform") }}
                  </p>
                </div>
              </div>
              <div class="card p-5 shadow">
                ...
                <div class="text-center">
                  ...
                  <p>
                    {{ $t("from each successful deposit from your friends") }}
                  </p>
                </div>
              </div>
            </div>
              ...
              <div class="lg:col-span-8">
                ...
                <div class="relative mb-2">
                  <input
                    ...
                    type="text"
                    :value="pathname + '/register/' + userStore.user.username"
                    readonly
                  />
                  <button
                    id="copyBoard"
