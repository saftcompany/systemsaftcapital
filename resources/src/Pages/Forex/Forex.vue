<template>
    <div>
                ...
                <div class="row match-height">
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6">
                                <div class="card text-center">
                                    <div class="card-body">
                                        <div
                                            class="icon-bg bg-light-primary mb-1"
                                        >
                            ...
                            <div class="col-xl-6 col-lg-6">
                                <div class="card text-center">
                                    <div class="card-body">
                                        <div
                                            class="icon-bg bg-light-warning mb-1"
                                        >
                                            <div class="avatar-content">
                                                <i
                            ...
                            <div class="col-xl-6 col-lg-6">
                                <div class="card text-center">
                                    <div class="card-body">
                                        <div
                                            class="icon-bg bg-light-success mb-1"
                                        >
                                            <div class="avatar-content">
                                                <i
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                        <div class="card card-transaction">
                            ...
                            >
                                <div
                                    v-for="(forex_log, index) in forex_logs"
                                    :key="index"
                                ...
                                >
                                    ...
                                    >
                                        <div
                                            class="icon-bg bg-light-primary rounded float-start me-1"
                                        >
                                            <div class="avatar-content">
                                                <span
                                                    v-if="forex_log.type == 1"
                                                ...
                                                <span
                                                    v-else-if="
                                                        forex_log.type == 3
                                                    "
                                                    class="text-warning font-medium-5"
                                                    ><i
                                ...
                                <form @submit.prevent="submitInvestment()">
                                    ...
                                    <div class="row">
                                        ...
                                        >
                                            ...
                                            >
                                                <button
                                                    class="btn btn-outline-warning dropdown-toggle w-100 mb-1"
                                                    type="button"
                        ...
                        <table class="table">
                            ...
                            >
                                ...
                                >
                                    ...
                                    <td
                                        v-else-if="investment_log.result == 2"
                                        data-label="Profit"
                                        class="text-danger"
                                    >
                                        -
                                    ...
                                    <td
                                        v-else-if="investment_log.result == 3"
                                        data-label="Profit"
                                    >
                                        {{
                                            investment_log.profit *
            ...
            <div v-if="getSignal(account.signal1_id) != null" class="col">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div
                            class="data-doc-item data-doc-item-lg mx-auto my-1"
                        >
                            ...
                            <ul class="data-doc-actions">
                                <li>
                                    <a
                                        ...
                                        target="_blank"
                                        ><i
                                            class="bi bi-cloud-download text-white"
                                        ></i
                                    ></a>
                                </li>
                            </ul>
        ...
        <div
            ...
            id="InvestmentType"
            tabindex="-1"
            aria-labelledby="InvestmentType"
            aria-hidden="true"
        >
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body pb-3 px-sm-3">
                        <template
                            v-for="(investment, index) in forex_investment"
                        >
                            <a
                                :key="index"
                                @click="
