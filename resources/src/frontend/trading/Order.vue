          ...
          <div class="space-y-3 text-center">
              ...
              >
                ...
                >
                  <input
                    ...
                    "
                    @change="getPerc('buy', 'market', rangeMB)"
                  />
              ...
              <div class="flex">
                ...
                >
                  ...
                  <a
                    ...
                    @click="
                      parseFloat(amountMarketBuy) - Min >= 0
            ...
            <div>
              ...
              >
                ...
                <span
                  >{{ $t("Processing Fee") }}:
                  <span class="text-warning">{{ fee }}%</span></span
                >
              </label>
              <div class="flex">
                <input
                  ...
                  :step="StepPrice"
                  aria-label="Amount (to the nearest dollar)"
                  @change="calculateTotalPrice('market', 'buy')"
                  @keyup="calculateTotalPrice('market', 'buy')"
                />
                <span
                  class="inline-flex flex-shrink-0 items-center rounded-r-md border border-gray-300 bg-gray-100 p-2 text-center text-xs text-gray-500 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200"
                  >{{ currency }}</span
                ...
                >
                  <input
                    ...
                    :style="
                      ...
                      '%, rgb(255 255 255 / 0.2) 100%)`'
                    "
                    @change="getPerc('sell', 'market', rangeMS)"
                  />
                  <div class="mt-1 flex w-full justify-between px-1">
                    <button
                      :key="rangeMS"
              ...
              <div class="flex">
                ...
                >
                  <a
                    ...
                    @click="
                      amountMarketSell = (
                        parseFloat(amountMarketSell) + Min
                      ).toFixed(PrecisionAmount);
                  ...
                  <a
                    class="px-2 hover:bg-gray-200 dark:hover:bg-gray-600 dark:focus:ring-gray-700"
                    @click="
                      parseFloat(amountMarketSell) - Min >= 0
                        ? (amountMarketSell = parseFloat(
                            parseFloat(amountMarketSell) - Min
                          ).toFixed(PrecisionAmount))
                        : '';
                      calculatePrice('market', 'sell');
            ...
            <div>
              ...
              <div class="flex">
                <input
                  ...
                  :step="StepPrice"
                  aria-label="Amount (to the nearest dollar)"
                  @change="calculateTotalPrice('market', 'sell')"
                  @keyup="calculateTotalPrice('market', 'sell')"
                />
                <span
                  class="inline-flex flex-shrink-0 items-center rounded-r-md border border-gray-300 bg-gray-100 p-2 text-center text-xs text-gray-500 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200"
                  >{{ currency }}</span
                ...
                >
                  <input
                    ...
                    :style="
                      ...
                      '%, rgb(255 255 255 / 0.2) 100%)`'
                    "
                    @change="getPerc('buy', 'limit', rangeLB)"
                  />
                  <div class="mt-1 flex w-full justify-between px-1">
                    <button
                      :key="rangeLB"
              ...
              <div class="flex">
                ...
                >
                  ...
                  <a
                    class="px-2 hover:bg-gray-200 dark:hover:bg-gray-600 dark:focus:ring-gray-700"
                    @click="
                      parseFloat(amountLimitBuy) - Min >= 0
            ...
            <div>
              ...
              <div class="flex">
                <input
                  ...
                  :step="StepLimitPrice"
                  aria-label="Amount (to the nearest dollar)"
                  @change="calculateTotalPrice('limit', 'buy')"
                ...
                >
                  <input
                    ...
                    :style="
                      ...
                      '%, rgb(255 255 255 / 0.2) 100%)`'
                    "
                    @change="getPerc('sell', 'limit', rangeLS)"
                  />
                  <div class="mt-1 flex w-full justify-between px-1">
                    <button
                      :key="rangeLS"
              ...
              <div class="flex">
                ...
                >
                  ...
                  <a
                    class="px-2 hover:bg-gray-200 dark:hover:bg-gray-600 dark:focus:ring-gray-700"
                    @click="
                      parseFloat(amountLimitSell) - Min >= 0
            ...
            <div>
              ...
              <div class="flex">
                <input
                  ...
                  :step="StepLimitPrice"
                  aria-label="Amount (to the nearest dollar)"
                  @change="calculateTotalPrice('limit', 'sell')"
                  @keyup="calculateTotalPrice('limit', 'sell')"
                />
                <span
                  class="inline-flex flex-shrink-0 items-center rounded-r-md border border-gray-300 bg-gray-100 p-2 text-center text-xs text-gray-500 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200"
                  >{{ currency }}</span
        ...
        <div class="grid grid-cols-2 gap-5">
          <div>
            <label
              ...
              class="border-1 peer flex w-full appearance-none justify-between rounded-lg border-gray-300 bg-transparent pb-2 text-xs text-gray-900 focus:border-blue-600 focus:outline-none focus:ring-0 dark:border-gray-600 dark:text-gray-200 dark:focus:border-blue-500"
            >
              <a class="text-dark">{{ symbol }} {{ $t("Wallet") }}</a>
            </label>
            <div>
              <button
                type="button"
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      MinPrice() {
        return this.marketStore.market.limits.price.min;
      },
      MinCost() {
      ...
      StepPrice() {
        return Number(
          this.marketStore.market.limits.amount.min * this.marketStore.bestAsk
        ).toFixed(this.marketStore.market.precision.price);
      },
      StepLimitPrice() {
    ...
    methods: {
      ...
      placeOrder(type, side) {
        ...
        if (type === "market") {
          if (side === "buy") {
            price = this.marketStore.bestAsk * this.pfee;
            order = 1;
      ...
      getPerc(side, type, perc) {
        ...
        const wallet =
          side === "buy" ? this.marketStore.walCur : this.marketStore.walSym;
        const bestPrice =
          side === "buy" ? this.marketStore.bestAsk : this.marketStore.bestBid;
        const price =
          type === "limit"
            ? side === "buy"
              ? this.priceBuy
