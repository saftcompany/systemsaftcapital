              ...
              <div class="overflow-hidden rounded-lg bg-white shadow-lg">
                ...
                <div class="p-4">
                  <div class="header-content inline-flex">
                    ...
                    >
                      <div class="m-1 h-2 w-2 rounded-full bg-purple-500"></div>
                    </div>
                    <div class="category-title flex-1 flex-col text-sm">
                  ...
                  <div class="summary-post text-justify text-xs">
...
<script>
  ...
  export default {
    ...
    watch: {
      rightbarCollapsed(newValue, oldValue) {
