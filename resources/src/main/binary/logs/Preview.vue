        ...
        <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="col">
              {{ $t("Sell price") }}:<br /><b>
                <toMoney
                  :num="contract.amount + contract.amount * gnl.profit"
                  decimals="4"
              /></b>
            </div>
          </div>
      ...
      <div class="card">
        <div class="card-body" style="max-height: 280px; overflow-y: auto;">
          <div class="row">
            ...
            <div class="col-9">
              {{ $t("Reference ID") }}:<br /><b>{{ contract.id }}</b>
            </div>
            <hr />
            <div class="row">
              <div class="col-3">
              ...
              <div class="col-9">
                {{ $t("Duration") }}:<br /><span
                  v-if="contract.duration >= 60 && contract.duration < 3600"
                  ><b> {{ contract.duration / 60 }}</b> {{ $t("Min") }}</span
                >
                ...
                <span v-else
                  ><b>{{ contract.duration }}</b> {{ $t("Sec") }}</span
                >
              </div>
            </div>
            <hr />
            ...
            <div class="row">
              ...
              <div class="col-9">
                {{ $t("Start time") }}:<br /><b>{{ contract.in_time }}</b>
              </div>
            </div>
            <hr />
            <div class="row">
              ...
              <div class="col-9">
                {{ $t("Entry spot") }}:<br /><b>
                  <toMoney :num="contract.price_was" decimals="4"
                /></b>
              </div>
            </div>
            <hr />
          ...
          <div class="col-12">
            <div class="card">
              ...
              >
                ...
                <div class="mt-sm-0 mt-1 flex flex-wrap items-center">
                  <h5 v-if="data.length > 0" class="fw-bolder mr-1 mb-0">
                    $ {{ data[data.length - 1].value }}
                  </h5>
                  <span
                    v-if="data.length > 0"
                  ...
                  >
                    ...
                    <span class="align-middle">
                      <toMoney :num="perc" decimals="4" />%</span
                    >
                  </span>
                </div>
              </div>
