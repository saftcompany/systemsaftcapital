        ...
        >
          <template #head>
            ...
            >
              ...
              <VTh sort-key="staked" scope="col" class="py-3 px-6">
          ...
          <template #body="{ rows }">
            <template v-if="stakingStore.logs != null">
              ...
              >
                ...
                <td class="py-3 px-6" data-label="Total Staking">
                  <span class="text-success fw-bold"
                    ><toMoney :num="row.staked ? row.staked : 0" decimals="4" />
                    {{ row.symbol }}</span
                  >
                </td>
                <td class="py-3 px-6" data-label="Profit">
                  <div>
                    ...
                    <span class="fw-bold text-success"
                      ><toMoney
                        :num="row.last_profit ? row.last_profit : 0"
                        decimals="4"
                    /></span>
                    USDT
                  </div>
                  <div>
                    ...
                    <span class="fw-bold text-success"
                      ><toMoney
                        :num="row.total_profit ? row.total_profit : 0"
                        decimals="4"
                    /></span>
                    USDT
                  </div>
                ...
                <td class="py-3 px-6" data-label="Duration">
                  ...
                  <div>
                    {{ $t("End") }}:
                    <span class="fw-bold text-warning">{{ row.end_date }}</span>
                  </div>
                </td>
                <td class="py-3 px-6" data-label="Status">
                  <span v-if="row.status == 0" class="badge bg-danger">{{
                    $t("Canceled")
                  }}</span>
                  ...
                  <span v-else-if="row.status == 3" class="badge bg-success">{{
                    $t("Claimed")
                  }}</span>
                </td>
              </tr>
