...
let mediaPath = "/builder/media";
let mediaScanUrl = "/builder/scan.php";
let uploadUrl = "/builder/upload.php";
...
class MediaModal {
    ...
    addFile(f, selected) {
        ...
        if (fileType == "jpg" || fileType == "jpeg" || fileType == "png" || fileType == "gif" || fileType == "svg" || fileType == "webp") {
            ...
            //icon = '<div class="image" style="background-image: url(' + mediaPath + f.path + ');"></div>';
            icon = '<img class="image" loading="lazy" src="' + mediaPath + f.path + '">';
            isImage = true;
        } else {
        ...
        let userActions = $(window).triggerHandler("mediaModal:fileActions", { file: mediaPath + f.path, name, fileType, fileSize, isImage, fileType, actions });
        ...
        var file = $('<li class="files">\
						...
						<input type="hidden" value="' + mediaPath + f.path + '" name="filename[]">\
