        ...
        <div class="section">
            <div class="columns is-centered">
                <div class="column is-two-fifths">
                        ...
                        <div class='content'>
                            <?php if ($update_data['status']) { ?>
                                ...
                                <center>
                                    ...
                                    <a href="https://support.mash3div.com/help-center/articles/3/bicrypto-installation"><button class="button is-link is-rounded">Go To Next Steps</button></a>
                                </center>
                            <?php } ?>
                        </div>
                    </div>
                    <?php if ($update_data['status']) { ?>
                        <center>
                            <a href="./step2.php"><button class="button is-link is-rounded">Click here after install complete to refresh last version released</button></a>
                        </center>
                    <?php } ?>
                </div>
            </div>
