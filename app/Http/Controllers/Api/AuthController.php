...
class AuthController extends Controller
{
     ...
     * Register a new user.
     *
     * @param Request $request The request object containing required query parameters.
     * @return JsonResponse
     *
     * @api
     * @param string $token The API token.
     ...
     * @param int|null $phone The user's phone number (optional).
     * @param string|null $reference The referrer's username (optional).
     */
