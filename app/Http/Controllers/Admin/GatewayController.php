...
class GatewayController extends Controller
{
    public function index()
    {
        ...
        return view('admin.gateway.list', compact('page_title'));
    }
    ...
    public function remove(Request $request, $code)
    {
        ...
        return response()->json([
            'type' => 'success',
            'message' => $name . ' has been removed from ' . $gateway->name
        ]);
    }
    ...
    public function gatewayCurrencyValidator(Request $request, Gateway $gateway)
    {
        ...
        if ($request->has('currency')) {
            foreach ($request->currency as $key => $currency) {
                ...
                $validation_rule['currency.' . $key . '.image']          = ['nullable', 'image', 'mimes:jpg,jpeg,png'];
