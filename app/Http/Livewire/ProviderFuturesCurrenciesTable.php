...
class ProviderFuturesCurrenciesTable extends DataTableComponent
{
    public string $idx;
    ...
    {
        return FutureCurrencies::query()->where('provider', $this->provider)->select('id', 'symbol', 'name', 'status');
    }
