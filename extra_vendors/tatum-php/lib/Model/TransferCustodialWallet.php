...
class TransferCustodialWallet extends AbstractModel
{
    ...
    protected static $_definition = [
        ...
        "contract_type" => ["contractType", "int", null, "getContractType", "setContractType", null, ["r" => 1, "e" => 1]],
     ...
     * Set contract_type
     *
     * @param int $contract_type The type of the asset to transfer. Set <code>0</code> for fungible tokens (ERC-20 or equivalent), <code>1</code> for NFTs (ERC-721 or equivalent), <code>2</code> for Multi Tokens (ERC-1155 or equivalent), or <code>3</code> for native blockchain currencies.
     * @throws \InvalidArgumentException
     * @return $this
     */
    public function setContractType(int $contract_type)
    {
